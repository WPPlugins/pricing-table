    ...
    <div style="padding: 10px;">
        <form action="" enctype="multipart/form-data" method="post">
            <p style="border: 1px solid #0490b3;padding: 5px 8px;background: #fafafa;color: #0490b3;border-radius: 2px;">
                Import <b>demo-table.txt</b> file from Pricing Table plugin folder if you are using this plugin for the first time (Quickstart). Or import previously exported table.
            </p>
